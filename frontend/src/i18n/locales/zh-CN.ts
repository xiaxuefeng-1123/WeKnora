export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        title: "创建你的知识库",
        desc: "知识库是一切的起点：上传文档、网页或 FAQ，Binqsoft 会自动解析并建立索引。点击这里进入知识库。",
      },
      chat: {
        title: "发起智能对话",
  ...
  system: {
    ...
    retry: "重试",
    versionLabel: "应用版本",
    versionDescription: "当前应用服务（binqsoft-app）的版本号",
    frontendVersionLabel: "UI 版本",
    frontendVersionDescription: "当前 UI 界面（binqsoft-ui）的构建版本号",
  ...
  createChat: {
    title: "Hi，我是 Binqsoft，让你的知识触手可及",
    newSessionTitle: "新会话",
    messages: {
